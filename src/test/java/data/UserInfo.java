...
public class UserInfo {
    ...
    public static final String LAST_NAME = "Shtyiuk";
    public static final String FULL_NAME = String.format("%s %s", FIRST_NAME, LAST_NAME);
    ...
    public static final String PROVINCE = "Volyn";
    public static final String CITY = "Lutsk";
}
