...
public class Main {
    public static void main(String[] args) {
        ...
        VehicleParking.waitConsole();
        AbstractVehicle truck7 = new Truck("Ivan Petrenko", "АА 5555 ОП");
        VehicleParking.waitConsole();
        AbstractVehicle truck8 = new Truck("Stephen King", "АА 5556 ТИ");
        AbstractVehicle truck9 = new Truck("George Martin", "АППА 5556 ТИ");
        AbstractVehicle truck10 = new Truck("Joanne Rowling", "АА 5556 ТИ");
        ...
        car6.checkIn(car6);
        truck7.checkIn(truck7);
        truck8.checkIn(truck8);
        truck9.checkIn(truck9);
        truck10.checkIn(truck10);
        truck11.checkIn(truck11);
        truck12.checkIn(truck12);
        System.out.println("\n");
        truck1.checkOut(truck1);
        car2.checkOut(car2);
        truck3.checkOut(truck3); //incorrect Vehicle number, car wasn't check
