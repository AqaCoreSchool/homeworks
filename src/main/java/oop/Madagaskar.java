...
public class Madagaskar extends Movie {
    private String nameOfMovie;
    private int yearOfRelease;
    private int movieDuration;
    private String movieGenre;
    private List<String> sessions = new ArrayList<>(Arrays.asList("18:00", "22:00"));

    public Madagaskar(String nameOfMovie, int yearOfRelease, int movieDuration, String movieGenre) {
